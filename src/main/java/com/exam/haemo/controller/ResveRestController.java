...
import com.exam.haemo.entity.MemberVo;
import com.exam.haemo.entity.Resve;
import com.exam.haemo.service.MemberService;
import com.exam.haemo.service.ResveService;
...
public class ResveRestController {
    // 기본형
...
//    }
    ...
    // 회원 입력
    @PostMapping
    public ResponseEntity<Resve> save(@RequestBody Resve resve) {
        return new ResponseEntity<Resve>(resveService.save(resve), HttpStatus.OK);
    }

    // 회원 입력
//    @RequestMapping(value="/resve", method = RequestMethod.GET)
